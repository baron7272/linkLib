package com.linkLibrary.commons.helpers
...
import com.linkLibrary.commons.extensions.getIntValue
import com.linkLibrary.commons.extensions.getStringValue
import com.linkLibrary.commons.models.PhoneNumber
import com.linkLibrary.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.linkLibrary.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.linkLibrary.dialer" && packageName != "com.linkLibrary.smsmessenger" && packageName != "com.linkLibrary.calendar.pro") {
                return contacts
            }
