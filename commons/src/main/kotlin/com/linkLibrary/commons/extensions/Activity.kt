...
import com.linkLibrary.commons.models.*
...
fun Activity.launchPurchaseThankYouIntent() {
    hideKeyboard()
    try {
        launchViewIntent("market://details?id=com.linkLibrary.thankyou")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.linkLibrary.gallery.pro" || applicationId == "com.linkLibrary.gallery.pro.debug") {
