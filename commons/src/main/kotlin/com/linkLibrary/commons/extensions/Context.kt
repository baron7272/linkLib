...
import com.linkLibrary.commons.helpers.*
import com.linkLibrary.commons.models.AlarmSound
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.linkLibrary.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.linkLibrary.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.linkLibrary.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.linkLibrary."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.linkLibrary.contacts") && !packageName.startsWith("com.linkLibrary.dialer")) {
        true
    } else if ((packageName.startsWith("com.linkLibrary.contacts") || packageName.startsWith("com.linkLibrary.dialer")) && isQPlus()) {
