...
import com.linkLibrary.commons.models.MyTheme
import com.linkLibrary.commons.models.RadioItem
import com.linkLibrary.commons.models.SharedTheme
import com.linkLibrary.commons.views.MyTextView
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupOptionsMenu()
        refreshMenuItems()
        isThankYou = packageName.removeSuffix(".debug") == "com.linkLibrary.thankyou"
        initColorVariables()
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.linkLibrary.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
