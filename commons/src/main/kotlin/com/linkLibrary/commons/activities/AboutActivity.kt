...
import com.linkLibrary.commons.dialogs.ConfirmationAdvancedDialog
import com.linkLibrary.commons.dialogs.RateStarsDialog
import com.linkLibrary.commons.extensions.*
import com.linkLibrary.commons.helpers.*
import com.linkLibrary.commons.models.FAQItem
...
class AboutActivity : BaseSimpleActivity() {
    ...
    private fun setupDonate() {
        if (resources.getBoolean(R.bool.show_donate_in_about) && !resources.getBoolean(R.bool.hide_all_external_links)) {
            ...
            about_donate_holder.setOnClickListener {
                launchViewIntent("https://linkLibrary.com/donate")
            }
        } else {
    ...
    private fun setupFacebook() {
        ...
        about_facebook_holder.setOnClickListener {
            var link = "https://www.facebook.com/linkLibrary"
            try {
    ...
    private fun setupReddit() {
        about_reddit_holder.setOnClickListener {
            launchViewIntent("https://www.reddit.com/r/linkLibrary")
        }
    }

    private fun setupTelegram() {
        about_telegram_holder.setOnClickListener {
            launchViewIntent("https://t.me/linkLibrary")
        }
    }
    ...
    private fun setupWebsite() {
        if (resources.getBoolean(R.bool.show_donate_in_about) && !resources.getBoolean(R.bool.hide_all_external_links)) {
            ...
            about_website_holder.setOnClickListener {
                launchViewIntent("https://linkLibrary.com/")
            }
        } else {
    ...
    private fun setupPrivacyPolicy() {
        ...
        about_privacy_policy_holder.setOnClickListener {
            val appId = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.linkLibrary.")
            val url = "https://linkLibrary.com/privacy/$appId.txt"
