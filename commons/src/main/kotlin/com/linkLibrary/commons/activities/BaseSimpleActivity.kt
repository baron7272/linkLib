...
import com.linkLibrary.commons.asynctasks.CopyMoveTask
import com.linkLibrary.commons.dialogs.*
import com.linkLibrary.commons.dialogs.WritePermissionDialog.Mode
import com.linkLibrary.commons.extensions.*
import com.linkLibrary.commons.helpers.*
import com.linkLibrary.commons.interfaces.CopyMoveListener
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("com.linkLibrary")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.linkLibrary.")
